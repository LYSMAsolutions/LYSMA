...
export default function ClientEditForm({
  ...
  const [address, setAddress] = useState(client.address_line_1 || "");
  ...
  const [assignedUserId, setAssignedUserId] = useState(client.assigned_user_id || "");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        setErrorMsg(data.message || "Impossible de modifier le client.");
        return;
      }
