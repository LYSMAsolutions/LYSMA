...
const services = [
  {
    ...
    href: '../prestations/reparation-carrosserie/index.html',
  },
  {
  ...
  },
  {
    ...
    href: '../prestations/covering/index.html',
  },
  {
    ...
    href: '../prestations/flocage/index.html',
  },
]
...
await writeFile(
  path.join(root, 'pages', 'zones-intervention.html'),
  `<!doctype html>
<html lang="fr">
<head>
  <meta charset="utf-8">
...
<body>
  <header class="site-header">
    <div class="container header-inner">
      <a class="logo" href="../index.html" aria-label="Accueil Carrosserie Mounier">
      ...
      <nav class="main-nav" aria-label="Navigation principale">
        ...
        <div class="menu-actions"><a href="tel:+33608378217">Appeler</a><a href="contact.html">Devis</a></div>
      </nav>
      <a class="btn btn-header" href="contact.html">Demander un devis</a>
      ...
      <div class="container hero-content">
        <div class="hero-copy reveal">
          ...
          <div class="hero-actions hero-bubble-actions">
            ...
            <a class="side-action side-action-devis" href="contact.html"><span>&#8599;</span><strong>Devis</strong><small>Demande rapide</small></a>
          </div>
        </div>
      </div>
    </section>
...
${communeItems}
  ...
  <div class="mobile-sticky-cta" aria-label="Actions rapides mobile"><a href="tel:+33608378217">Appeler</a><a href="contact.html">Devis</a></div>

  <footer class="site-footer">
    <div class="container footer-inner">
      <div><strong>Carrosserie Mounier</strong><br>Carrosserie, entretien, covering et flocage à Trélissac.</div>
      <div class="footer-links"><a href="prestations.html">Prestations</a><a href="realisations.html">Réalisations</a><a href="zones-intervention.html">Zones d'intervention</a><a href="../faq/index.html">FAQ</a><a href="contact.html">Contact</a></div>
