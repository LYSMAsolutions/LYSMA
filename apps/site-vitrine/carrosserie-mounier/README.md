...
- Accueil : `/index.html`
- Prestations : `/pages/prestations.html`
- Realisations : `/pages/realisations.html`
- Contact : `/pages/contact.html`
- Recrutement : `/pages/recrutement.html`
- Zones d'intervention : `/pages/zones-intervention.html`
- FAQ : `/faq/index.html`
...
La page `pages/zones-intervention.html` sert de socle SEO local. Elle mentionne les services principaux :
...
Depuis le dossier `apps/site-vitrine/carrosserie-mounier` :
...
La page `pages/contact.html` envoie les demandes vers Google Apps Script.
...
La page `pages/recrutement.html` envoie :
...
La logique cookies est dans `js/main.js` et la page d'information dans `pages/cookies.html`.
