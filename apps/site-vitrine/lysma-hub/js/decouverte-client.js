...
function readPayload(sourceForm) {
  ...
  return {
    ...
    seoTargetCities: getValue(formData, 'seoTargetCities'),
    seoPriorityServices: getValue(formData, 'seoPriorityServices'),
    seoKnownKeywords: getValue(formData, 'seoKnownKeywords'),
    seoGrowthServices: getValue(formData, 'seoGrowthServices'),
    seoSpecialities: getValue(formData, 'seoSpecialities'),
    seoAdvantages: getValue(formData, 'seoAdvantages'),
    idealCustomer: getValue(formData, 'idealCustomer'),
    mainBusinessAreas: getValue(formData, 'mainBusinessAreas'),
    excludedKeywords: getValue(formData, 'excludedKeywords'),
    faqQuestion1: getValue(formData, 'faqQuestion1'),
    faqAnswer1: getValue(formData, 'faqAnswer1'),
    faqQuestion2: getValue(formData, 'faqQuestion2'),
    faqAnswer2: getValue(formData, 'faqAnswer2'),
    faqQuestion3: getValue(formData, 'faqQuestion3'),
    faqAnswer3: getValue(formData, 'faqAnswer3'),
    faqQuestion4: getValue(formData, 'faqQuestion4'),
    faqAnswer4: getValue(formData, 'faqAnswer4'),
    faqQuestion5: getValue(formData, 'faqQuestion5'),
    faqAnswer5: getValue(formData, 'faqAnswer5'),
