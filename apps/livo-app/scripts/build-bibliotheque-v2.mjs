...
const renamed = {
  ...
  'ENT-002': 'Filtre à air moteur',
  'ENT-003': 'Filtre habitacle',
  'ENT-004': 'Filtre à carburant',
  'ENT-005': 'Révision moteur',
  'ENT-006': 'Bougies d’allumage',
  'ENT-007': 'Bougies de préchauffage',
  'ENT-008': 'Courroie accessoires',
  'ENT-009': 'Liquide de refroidissement',
  'ENT-010': 'Liquide de frein',
...
const specific = {
  'ENT-001': {
    pieces_suggerees: ['Huile moteur', 'Filtre à huile', 'Joint de vidange si nécessaire'],
...
const pieces = {
  ...
  'ENT-006': ['Bougies d’allumage'],
  'ENT-007': ['Bougies de préchauffage'],
  'ENT-008': ['Courroie accessoires', 'Galet tendeur si nécessaire'],
  'ENT-009': ['Liquide de refroidissement'],
  'ENT-010': ['Liquide de frein'],
